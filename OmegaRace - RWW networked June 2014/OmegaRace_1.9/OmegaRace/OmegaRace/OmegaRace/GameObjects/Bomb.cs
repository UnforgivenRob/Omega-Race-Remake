...
namespace CollisionManager
{
    ...
    class Bomb : GameObject
    {
        ...
        private void reactionToBomb(Missile m, Bomb b, Vector2 _man)
        {
        ...
        private void reactionToBomb(Ship s, Bomb b, Vector2 _man)
        {
