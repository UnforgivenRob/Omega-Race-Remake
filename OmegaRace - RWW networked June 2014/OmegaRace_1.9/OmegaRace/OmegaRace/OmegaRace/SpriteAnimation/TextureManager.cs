...
namespace SpriteAnimation
{
    ...
    class TextureManager : Manager
    {
        ...
        private void createTexts()
        {
            ...
            this.privActiveAddToFront((ManLink)(new Text("SpriteFont2", TextEnum.font2, 0, 70, 86, true, Type.Text_Font)), ref this.active); 
            ...
            //Menu
            this.privActiveAddToFront((ManLink)(new Text("MainMenu", TextEnum.Menu, 0, 480, 800, true, Type.Text_Sprite)), ref this.active);
